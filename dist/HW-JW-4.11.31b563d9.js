...
function atomBomb() {
    ...
    const timer = setInterval(()=>{
        sec -= 1;
        getMessage.innerHTML = `\u{437}\u{430}\u{43B}\u{438}\u{448}\u{438}\u{43B}\u{43E}\u{441}\u{44C}: ${sec}\u{445}\u{432}`;
        if (sec === 30) alert("\u0412\u0436\u0435 \u043F\u0440\u043E\u0439\u0448\u043B\u043E 30\u0445\u0432");
        else if (sec === 0) {
            clearInterval(timer);
...
function startTimer() {
    ...
    const timer = setInterval(()=>{
        timeLeft -= interval;
        if (timeLeft <= animationThreshold) timerDisplay.classList.add("animate");
        if (timeLeft <= 0) {
            clearInterval(timer);
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire7053", {})

//# sourceMappingURL=HW-JW-4.11.31b563d9.js.map
